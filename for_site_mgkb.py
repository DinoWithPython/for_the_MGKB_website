...
with open('text.txt', 'w') as f:
    for i in range(1):
        ...
        for j in range(1):
            ...
            for k in range(1):
                print(
                    '<tr style="text-align: left; border: 1px solid #000000; border-collapse: collapse;">', file=f)
                for l in range(1):
                    ...
                    print(
                        f'<span style="font-size: 18pt">{data_zag[0]}</span>', file=f)
                    print('</th>', file=f)
                    ...
                    print(
                        f'<span style="font-size: 18pt">{data_zag[1]}</span>', file=f)
                    print('</th>', file=f)

                    print('<th style="border-left: 1px solid #000000; border-collapse: collapse; padding: 7px 4px 7px 15px; height: 28px; width: 117px;">', file=f)
                    print(
                        f'<span style="font-size: 18pt">{data_zag[2]}</span>', file=f)
                    print('</th>', file=f)
                    ...
                    print(
                        f'<span style="font-size: 18pt">{data_zag[3]}</span>', file=f)
                    print('</th>', file=f)
                    ...
                    print(
                        f'<span style="font-size: 18pt">{data_zag[4]}</span>', file=f)
                    print('</th>', file=f)
            ...
            for m in range(1, 86):
                ...
                if 'функционал' in data_zag[2]:
                    print('<td style="padding: 7px 4px 7px 15px; color: #47433f; border-collapse: collapse; border: 1px solid #000000; height: 14px; width: 117px;">', file=f)
                    print(
                        f'<span style="font-size: 15pt;color: salmon">{data_zag[2]}</span>', file=f)
                    print('</td>', file=f)
                else:
                    print('<td style="padding: 7px 4px 7px 15px; color: #47433f; border-collapse: collapse; border: 1px solid #000000; height: 14px; width: 117px;">', file=f)
                    print(
                ...
                if data_zag[3] != None:
                    ...
                    if data_zag[3] == 'раздел в разработке':
                        print('<td style="padding: 7px 4px 7px 15px; color: #47433f; border-collapse: collapse; border: 1px solid #000000; height: 14px; width: 147px;">', file=f)
                        print(
                            '<span style="font-size: 15pt;color: lightgrey">раздел в разработке</span>', file=f)
                        print('</td>', file=f)
                    else:
                        print('<td style="padding: 7px 4px 7px 15px; color: #47433f; border-collapse: collapse; border: 1px solid #000000; height: 14px; width: 147px;">', file=f)
                        print(
                            '<ul style="padding: 7px 4px 7px 15px; font-size: 15pt">', file=f)
                ...
                print(
                    f'<a href="{data_zag[5]}" style="color: #27609b; text-decoration: none" target="_blank">{data_zag[4]}</a>', file=f)
                print('</span>', file=f)
                print('</td>', file=f)
                print('</tr>', file=f)
            print('</tbody>', file=f)
        ...
        print(
            '            if (td[j].innerHTML.toUpperCase().indexOf(filter) > -1) {', file=f)
